...
const int32_t STRING_INTERNET_REASON = 0x01000004;
const int32_t STRING_MODULE_DESC = 0x01000005;
const int32_t STRING_NETWORK_REASON = 0x01000006;
const int32_t STRING_STORAGE_REASON = 0x01000007;
const int32_t COLOR_START_WINDOW_BACKGROUND = 0x01000008;
const int32_t MEDIA_APP_ICON = 0x01000000;
const int32_t MEDIA_ICON = 0x01000009;
